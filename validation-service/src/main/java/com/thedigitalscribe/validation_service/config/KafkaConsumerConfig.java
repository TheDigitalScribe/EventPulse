package com.thedigitalscribe.validation_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PurchaseEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "validation-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);

        JsonDeserializer<PurchaseEvent> deserializer = new JsonDeserializer<>(PurchaseEvent.class);
        deserializer.addTrustedPackages("com.thedigitalscribe.model");
